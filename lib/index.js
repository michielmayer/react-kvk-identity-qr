  ...
  function IdentityQR(props) {
    ...
    _this.showQRHandler = function (linkTo) {
      ...
      _axios2.default.post(baseUrl + '/api/session', {
        ...
        setTimeout(_this.getAttest.bind(_this), 4000);

        _this.props.onShowQR();
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 20:
              ...
              return _context.abrupt('return', setTimeout(this.getAttest.bind(this), 2000));
          ...
          this.isMobile && _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { onClick: function onClick() {
                  return _this2.showQRHandler('web');
                } },
              'Log in met KvK ID app (in browser)'
            )
          )
        ),
